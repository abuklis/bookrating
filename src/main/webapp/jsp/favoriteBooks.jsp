...
<body>
    ...
    <div class="container-fluid book-list">
        <h2 class="blue-text text-xs-center"> Favorite books : </h2>
                ...
                <div class="col-md-4 margin-bottom-sm-3">
                    <div class="tm-3-col-box gray-bg book-item">
                        <div class="">
                            ...
                            <a href="controller?command=deleteBookFromFavorite&bookId=${bookItem.bookId}&login=${sessionScope.user.login}" class="button alt">
                                <img src="img/cross.png" alt="" class="delete-cross"/>
                            </a>
                        </div>
