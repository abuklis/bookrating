    ...
    <div class="row gray-bg">
        ...
        <section id="tm-section-4" class="tm-section">
            <div class="tm-container">
                ...
                <h2 class="blue-text text-xs-center">Search</h2>
                <h3 class="text-xs-center">Choose parameters you need</h3>

                <form name="addBookForm" action="controller" method="POST" class="tm-contact-form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"><input type="text" class="form-control" id="title" name="title"/></div>
                        <div class="col-md-3"></div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"><input type="text" class="form-control" id="publishingYear" name="publishingYear"/></div>
                        <div class="col-md-3"></div>
                    </div>
