    ...
    <div class="row gray-bg">
        ...
        <section id="tm-section-4" class="tm-section">
            <div class="tm-container">
                ...
                <h2 class="blue-text text-xs-center">Add author</h2>
                ...
                <form name="addAuthorForm" action="controller" method="POST" enctype="multipart/form-data" class="tm-contact-form">
