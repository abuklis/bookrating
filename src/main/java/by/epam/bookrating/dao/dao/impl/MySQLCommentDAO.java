...
public class MySQLCommentDAO extends CloseStatement implements CommentDAO {
    ...
    private static final String SQL_FIND_USER_COMMENTS_BY_LOGIN =
            "SELECT COMMENT_ID, BOOK_ID, USER_LOGIN ,COMMENT_DATE, COMMENT_TEXT " +
                    "FROM COMMENTS JOIN USERS ON COMMENTS.USER_LOGIN=?";
