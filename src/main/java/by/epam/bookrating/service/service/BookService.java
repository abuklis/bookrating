...
import by.epam.bookrating.dao.dao.BookDAO;
...
public class BookService {
    ...
    private final static String AUTHORS_DELIMITER = ",";
    private final static String DESCRIPTION = "description";
    private final static String PUBLISHING_YEAR = "publishingYear";
    ...
    private final static String BOOK_LIST = "books";
    ...
    public void deleteBook(long bookId) throws ServiceException {
        try{
            ...
            MySQLAuthorDAO.getInstance().deleteAllAuthorsForBook(bookId);
