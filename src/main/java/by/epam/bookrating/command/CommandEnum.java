...
import by.epam.bookrating.command.impl.ChangeLocaleCommand;
import by.epam.bookrating.command.impl.LeaveRatingCommand;
import by.epam.bookrating.command.impl.book.*;
import by.epam.bookrating.command.impl.comment.BanUserCommand;
import by.epam.bookrating.command.impl.user.*;
import by.epam.bookrating.command.impl.comment.*;
